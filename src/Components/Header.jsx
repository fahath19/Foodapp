        ...
        <header className=' bg-[#FAF9F6] shadow-[0_8px_30px_rgb(0,0,0,0.12)] py-5   w-full z-20 '>
          <div className='max-w-[1200px] mx-auto flex justify-between'> 
           ...
           >
                     ...
                     <Link to='/' > <li className='text-[1.3rem] md:hover:text-orange-600 text-center font-medium md:pr-10 pr-0 cursor-pointer  text-[#343434] md:mt-auto mt-3  flex items-start justify-start hover:bg-orange-500 hover:text-white  w-[300px] md:hover:bg-transparent md:w-auto pl-4 rounded' >  Search  </li> </Link>  
